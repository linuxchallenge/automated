...
def calculate_equity_intraday(buy_price, sell_price, quantity):
    # Turnover
...
def calculate_equity_delivery(buy_price, sell_price, quantity):
    # Turnover
    turnover = (buy_price + sell_price) * quantity
...
def calculate_equity_futures(buy_price, sell_price, quantity):
    # Turnover
    turnover = (buy_price + sell_price) * quantity
    ...
    # STT on sell side only, 0.05% (revised w.e.f. 01-Apr-2026)
...
def calculate_equity_options(buy_price, sell_price, quantity):
    # Turnover
    turnover = (buy_price + sell_price) * quantity
    ...
    # STT on sell side only, 0.15% of sell premium (revised w.e.f. 01-Apr-2026)
    stt = 0.0015 * sell_price * quantity
...
def calculate_currency_futures(buy_price, sell_price, quantity):
    # Turnover
...
def calculate_currency_options(buy_price, sell_price, quantity):
    # Turnover
    turnover = (buy_price + sell_price) * quantity * 1000  # Lot size is 1000
...
def calculate_commodity_futures(buy_price, sell_price, quantity, multiplier):
    # Turnover
...
def calculate_commodity_options(buy_price, sell_price, quantity, multiplier):
